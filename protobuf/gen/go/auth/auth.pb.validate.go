...
// Validate checks the field values on UpdateTokensResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateTokensResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateTokensResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateTokensResponseMultiError, or nil if none found.
func (m *UpdateTokensResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateTokensResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateTokensResponseMultiError(errors)
	}

	return nil
}

// UpdateTokensResponseMultiError is an error wrapping multiple validation
// errors returned by UpdateTokensResponse.ValidateAll() if the designated
// constraints aren't met.
type UpdateTokensResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateTokensResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateTokensResponseMultiError) AllErrors() []error { return m }

// UpdateTokensResponseValidationError is the validation error returned by
// UpdateTokensResponse.Validate if the designated constraints aren't met.
type UpdateTokensResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateTokensResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateTokensResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateTokensResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateTokensResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateTokensResponseValidationError) ErrorName() string {
	return "UpdateTokensResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateTokensResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateTokensResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateTokensResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateTokensResponseValidationError{}
